...
class create_jpg :
    ...
    def generate_glitch_image(self) -> bool :
        ...
        for index_jpg in range(self.stock) :
            ...
            print(f"generate [ {index_jpg + 1} / {self.stock} ] [ {int((percentage/self.stock)*100)} % ] ..................... [ total size : {int(size/1024000)}MB ]")
    ...
    def generate_image_to_gif(self) -> None :
        ...
        for filename in filenames:
            ...
            print(f"images initialization [ {len(images)} / {len(filenames)} ] ............................... [ {int((len(images)/len(filenames))*100)} % ]")
        ...
        print(f"\n[ generate {self.output} ] ................... success [ size : {int(os.path.getsize(self.output)/1024000)}MB ]")
